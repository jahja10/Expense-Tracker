...
public interface ICategoryRepository
{
        ...
        Task<ErrorOr<List<Category>>> GetCategoriesAsync (int userId, CancellationToken cancellationToken);

        Task <ErrorOr<Category>> GetCategoryByIdAsync(int id, int userId, CancellationToken cancellationToken);

        Task<ErrorOr<Category>> GetCategoryByNameAsync(string name, int userId, CancellationToken cancellationToken);  
